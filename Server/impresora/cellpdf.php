...
function AcceptPageBreak()
{
    ...
    if($this->col<1)
    {
        ...
        $this->SetY($this->y=0);//<---- ESTABLEE LA POSICION Y EN +10 PARA ALINEAR.
...
/*
 *FUNCION QUE GENERA LOS CODIGOS DE BARRA PARA LAS GIAS
 *
 *
*/
function Codabar($xpos, $ypos, $code, $start='A', $end='A', $basewidth=0.25, $height=5) {
    ...
    // $this->SetFont('Arial','',6);<-----tamaño del texto o codigo escrito
    //$this->Text($xpos, $ypos + $height + 4, $code);<-----muestra el texto o codigo escrito
    $this->SetFillColor(0);
...
}//fin de la funcion que genera el codigo de barras.
